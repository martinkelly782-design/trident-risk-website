...
function HomePage({ onOpenPage }) {
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-[#f7f5f1] px-6 py-16 lg:px-8">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(181,137,61,0.05),transparent_26%)]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-7 max-w-2xl text-3xl font-light leading-tight tracking-tight text-[#0f172a] md:text-5xl">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                <div
                  key={num}
                  className="group overflow-hidden rounded-[1.25rem] bg-white shadow-lg shadow-slate-500/10 ring-1 ring-slate-200 transition duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
                  <div
                  ...
                  <div className="p-5">
                    <div className="text-2xl font-semibold tracking-widest text-[#b5893d]">
                      {num}
                    </div>

                    <h3 className="mt-4 text-lg font-semibold uppercase leading-tight tracking-tight text-[#0f172a]">
                      {title}
                    </h3>
