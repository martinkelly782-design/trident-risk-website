...
<div className="absolute inset-0 bg-gradient-to-r from-[#111827]/60 via-[#111827]/25 to-transparent" />
      ...
      <section className="relative overflow-hidden bg-[#111827] px-6 py-28 lg:px-8">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(214,178,94,0.16),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(255,255,255,0.08),transparent_28%)]" />
